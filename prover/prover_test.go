...
func TestProver(t *testing.T) {
	testProver(t, 12, 20, "post1.bin", "merkle1.bin")
}

func BenchProver(b *testing.B) {
	benchProver(b, 12, 20, "post1.bin", "merkle1.bin")
}

// n - Table size T = 2^n
// l - iPoW difficulty and the # of nonce bits to store per entry
func benchProver(t *testing.B, n uint64, l uint, postFileName string, merkleFileName string) {
